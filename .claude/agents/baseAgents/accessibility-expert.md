...
description: 'Ensures all code and UI adhere to WCAG 2.1/2.2 Level AA accessibility standards. Use when reviewing HTML, CSS, or JavaScript for accessibility issues, auditing components against WCAG criteria, or generating accessible alternatives with annotated fixes.'
...
> Note: Playwright browser automation for live accessibility audits requires an MCP Playwright server configured in Claude Code settings.
