...
description: 'Creates and maintains Playwright UI tests following Page Object Model conventions, aligned with repository standards. Use when writing, extending, or fixing UI automation tests in a Playwright project, exploring app behavior before test design, or running regression validation.'
tools:
  - Bash
  - Read
  - Glob
...
- After the plan is created and reviewed, explore the page using **MCP Playwright**.
...
- Execute all tests using a suitable command, e.g.: `npx playwright test`
