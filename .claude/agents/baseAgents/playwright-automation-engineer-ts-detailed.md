...
description: 'Provides expert guidance, code, and troubleshooting for end-to-end and component-level test automation using Playwright with TypeScript. Use when writing or reviewing Playwright tests, debugging flaky tests, setting up CI integration, or applying patterns like POM, Builder, and Fixture to a test suite.'
...
# Playwright Automation Engineer — Operating Manual (Detailed)
